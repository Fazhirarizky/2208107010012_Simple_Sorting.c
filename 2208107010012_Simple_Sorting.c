...
// Fungsi untuk menghasilkan angka acak pada array
...
// Fungsi untuk melakukan sorting dan mencatat waktu eksekusi
void performSort(const char *sortName, void (*sortFunction)(int*, int), int *data, int size, FILE *file);

int main() {
     // Array yang berisi ukuran masukan yang berbeda
